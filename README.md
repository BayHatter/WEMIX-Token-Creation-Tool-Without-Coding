# WEMIX3.0 Token Creation Tool

A simple frontend tool to create tokens on the WEMIX3.0 (WEMIX) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/WEMIX-Token-Creation-Tool-Without-Coding.git
- And press deploy
- Congrats your WEMIX3.0 Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/WEMIX-Token-Creation-Tool-Without-Coding
- Upload into your Github repo.
- Edit the file public/config.json and insert your WEMIX3.0 wallet address for receiving fees. Also set fee in WEMIX that you want to charge
